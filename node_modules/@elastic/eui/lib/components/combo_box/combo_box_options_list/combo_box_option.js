...
exports.EuiComboBoxOption = undefined;
...
var EuiComboBoxOption = exports.EuiComboBoxOption = function (_Component) {
  ...
  function EuiComboBoxOption() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EuiComboBoxOption.__proto__ || Object.getPrototypeOf(EuiComboBoxOption)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {
  ...
  _createClass(EuiComboBoxOption, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['children', 'className', 'optionRef', 'option', 'onClick', 'onEnterKey', 'disabled']);

      var classes = (0, _classnames2.default)('euiComboBoxOption', className);
