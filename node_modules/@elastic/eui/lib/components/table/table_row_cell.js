...
var EuiTableRowCell = function EuiTableRowCell(_ref) {
  var align = _ref.align,
      ...
      rest = _objectWithoutProperties(_ref, ['align', 'children', 'className', 'truncateText', 'showOnHover', 'textOnly', 'colSpan']);
  ...
  if (textOnly === true) {
    ...
    modifiedChildren = _react2.default.Children.map(children, function (child) {
      return _react2.default.cloneElement(child, { className: childClasses });
    });
  }

  return _react2.default.createElement(
    'td',
    { className: 'euiTableRowCell', colSpan: colSpan },
